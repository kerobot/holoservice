...
@router.get(
    "/streamers/{id}", response_model=StreamerModel, response_model_by_alias=False
)
...
@router.get(
    "/streamers", response_model=StreamerCollection, response_model_by_alias=False
)
async def list_streamers(
    ...
    return await StreamerRepository.list(db, group)
