...
class ScheduleRepository:
    @staticmethod
    async def get_by_id(db, id: str) -> ScheduleModel:
    ...
    @staticmethod
    async def list(db, date: date = None, code: str = None) -> ScheduleCollection:
        schedule_collection = db.get_collection("schedules")
        filter_dict = {}
        if date is not None:
    ...
    @staticmethod
    async def create(db, schedule: ScheduleModel) -> ScheduleModel:
        schedule_collection = db.get_collection("schedules")
    ...
    @staticmethod
    async def update(db, id: str, schedule: ScheduleModel) -> ScheduleModel:
        schedule_collection = db.get_collection("schedules")
